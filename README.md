...
- **Cephalari workstations**: the Brine Garden Basin and Tendril-Forge are functional job-site blocks for custom Cephalari professions. Nutrient-Keepers propagate berries, seeds, and brine cultures, while Architects spin resonance-fed tendril stock from runic inputs. Both stations use local attuned/runic resonance bonuses instead of the retired machinery subsystem, and both professions now render dedicated live/zombified overlay attire.
