...
- **Cephalari adult forms**: Spiral Strider, DriftSkimmer, Treadwinder, and Echo Harness all share the embedded Cephalari body/profession texture mapping path, render through explicit shell/body/profession layer passes for both live Cephalari appearances and stand-alone adult-form entities, and now use their dedicated adult-form sleep loops both for stand-alone night rest and while bed-sleeping Cephalari villagers are rendered through those adult appearances, with the in-bed pose mirror restricted to east-west bed facings and applied separately from the spawn-time left-handed variant so the disconnected sleep rigs do not clip into one side of the bed.
