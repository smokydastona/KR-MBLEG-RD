...
- **Pebble Wren**: small tameable Wayfall bird with a twitchier songbird rhythm; it now favors visible perches like branches and posts, uses frequent short bursts between them, regroups quickly, and still gives its ore-direction ping when befriended.
