...
- **Paleweft (Wayfall farming)**: Paleweft Grass spawns in Wayfall biomes (worldgen; mix of short + tall) and can also bloom from bonemealed Runegrowth; Paleweft Seeds can be farmed into Paleweft Corn yielding Weftkern + rare Echokern, craftable into Weftmeal.
