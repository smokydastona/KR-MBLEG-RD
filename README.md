...
- **Pebble Wren**: small tameable ambient songbird that now naturally roams every Wayfall biome and the Overworld, while keeping its twitchier perch-and-flight rhythm, ore-direction ping, and dedicated custom chirp/flourish/flutter sound set.
- **Wayfall bats**: vanilla bats now also receive a Wayfall biome-spawn injection so they share the Pebble Wren biome coverage there, while Overworld bat spawning stays on vanilla rules instead of being double-added by the mod.
