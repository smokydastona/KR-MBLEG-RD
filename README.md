...
- **Pebble Wren**: small tameable Wayfall bird with a twitchier songbird rhythm; it now prefers higher visible perches like branches and posts, can answer nearby perch chirps with tiny flourishes, coordinates short perch hops a bit more in small flocks, and still gives its ore-direction ping when befriended.
