...
- **Telekinesis enchantment**: a new very-rare mainhand enchantment for breakable tools and weapons that routes block and mob drops straight into the killer's inventory when space allows, spilling only leftovers at the player.
