...
- **Cephalari adult forms**: Spiral Strider, DriftSkimmer, Treadwinder, and Echo Harness all share the embedded Cephalari body/profession texture mapping path, and their renderer now draws the embedded Cephalari subtree before the outer shell so the two tighter shell geos do not visually collapse to the rider layer.
