...
- **Pebble Wren**: small tameable Wayfall bird with a twitchier songbird rhythm; it now prefers higher visible perches like branches and posts, uses frequent short bursts between them, adds subtle perched head-bobs and tail flicks, regroups quickly, and still gives its ore-direction ping when befriended.
