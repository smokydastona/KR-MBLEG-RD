...
- **Cephalari adult forms**: Spiral Strider, DriftSkimmer, Treadwinder, and Echo Harness all share the same embedded Cephalari body/profession texture mapping path for rider overlays, and Spiral Strider plus DriftSkimmer now use dedicated full-coverage shell atlases so their outer body layers render consistently with Treadwinder and Echo Harness instead of sampling transparent golem-atlas gaps.
