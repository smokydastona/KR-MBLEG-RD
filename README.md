...
- **Ashspire flora**: the Wayfall Ashspire cactus line now uses only the canonical `ashspire_emberbloom_*` cap assets that are actually referenced at runtime, with the dead cap remaining a separate placeable item state.
