...
- **Animation:** `animation.kruemblegard.attack_p1_fast`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p1_heavy`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p1_ranged`.
...
- **Telegraph:** dash sound + soul particles; plays `animation.kruemblegard.attack_p2_fast`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p2_heavy`.
- **Timing:** `totalTicks = 18`, `impactAt = 10`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p2_ranged`.
...
- **Telegraph:** dash sound + soul particles; plays `animation.kruemblegard.attack_p3_fast`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p3_heavy`.
...
- **Telegraph:** storm sound + soul particles; plays `animation.kruemblegard.attack_p3_ranged`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p4_fast`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p4_heavy`.
...
- **Telegraph:** attack sound + soul particles; plays `animation.kruemblegard.attack_p4_ranged`.
- **Timing:** `totalTicks = 22`, `impactAt = 12`.
- **Impact frame (Blockbench @20 FPS):** **Frame 10**.
