...
- **Scaralon Beetle** (`scaralon_beetle`)
  ...
  - Flight uses **stamina**: while in flight mode you can hover/ascend/descend until stamina runs out; when empty, the beetle **forces an auto-land** (you lose fine control and it rapidly descends straight down). Stamina regenerates while on the ground.
