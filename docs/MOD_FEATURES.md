...
- **Cephalari** (`cephalari`)
  ...
  - Trading: Nutrient-Keepers and Architects both use full five-tier trade pools with multiple offers per rank. Their trades now pull from Krümblegard crop stock, flora, runic materials, crafted workstation outputs, and their own job-site blocks in a tighter vanilla-style progression, with master-only gift/masterwork offers that require both emeralds and a themed catalyst item.
