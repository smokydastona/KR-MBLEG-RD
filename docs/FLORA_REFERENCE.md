...
- Placeholder textures are generated by: `tools/generate_placeholder_textures.ps1`
- Wayfall plant textures are generated by: `tools/generate_plant_palette_textures.ps1` (driven by `docs/Plant_Material_Bible.md`)
...
- Worldgen: Wayroot uses `kruemblegard:ashmoss` as its dirt provider and is tuned toward a baobab-style silhouette.
- Placeholder textures:
