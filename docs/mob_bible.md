...
- Behavior: tameable bird with an active songbird-style perch-and-flight rhythm, airborne wandering/flocking when displaced, and an ore-direction ping when befriended.
