...
- Behavior: tameable bird with a twitchy songbird-style perch-and-flight rhythm, preferred visible perches, airborne wandering/flocking when displaced, and an ore-direction ping when befriended.
