...
- Behavior: tameable bird with a twitchy songbird-style perch-and-flight rhythm, a preference for higher visible perches, perched idle head-bobs/tail flicks, airborne wandering/flocking when displaced, and an ore-direction ping when befriended.
