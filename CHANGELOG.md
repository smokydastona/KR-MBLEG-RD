...
## 1.0.303 (2026-01-08)
- Fix(worldgen): prevent a Wayfall chunk-gen crash (`Feature order cycle found`) by ensuring the global Wayfall vegetation injection applies in a consistent order across all Wayfall biomes.
