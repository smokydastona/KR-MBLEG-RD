...
## Unreleased
- Feat(structure/overworld): add Ancient Way Ruins as a globally limited overworld structure sourced from `wayfall_temple.schem`, anchored to the schematic's red wool origin marker, cleaned of marker wool during processing, kept away from vanilla strongholds, sold by cartographer explorer maps, weathered during placement, and restricted to Cephalari zombie-family monster spawns plus Warden-capable shriekers.
