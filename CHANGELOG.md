...
## 1.0.1353 (2026-03-23)
- Fix(ashspire/assets): keep Ashspire Emberbloom on the Ashspire palette in its dead age by routing the cap through retextured vanilla chorus-flower models instead of the vanilla purple dead texture.
