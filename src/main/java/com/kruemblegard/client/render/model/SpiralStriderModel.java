...
public class SpiralStriderModel extends GeoModel<SpiralStriderEntity> {
    ...
    private static final String SPIRAL_STRIDER_TEXTURE_PATH = "textures/entity/cephalari/cephalari_adult_form_shell/cephalari_adult_form_shell_";
    ...
    public ResourceLocation getTextureResource(SpiralStriderEntity animatable) {
        ...
        return new ResourceLocation(Kruemblegard.MOD_ID, SPIRAL_STRIDER_TEXTURE_PATH + variant + ".png");
    }
