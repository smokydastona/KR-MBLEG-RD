...
public class KruemblegardBoatEntity extends Boat {
    ...
    private static final EntityDataAccessor<String> DATA_KRUEMBLEGARD_TYPE =
            SynchedEntityData.defineId(KruemblegardBoatEntity.class, EntityDataSerializers.STRING);

    public KruemblegardBoatEntity(EntityType<? extends KruemblegardBoatEntity> type, Level level) {
        super(type, level);
    }
    ...
    public Item getDropItem() {
        Item item = getKruemblegardBoatType().boatItem();
