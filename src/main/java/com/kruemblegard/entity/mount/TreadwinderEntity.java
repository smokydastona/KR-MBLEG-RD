...
public class TreadwinderEntity extends CephalariMountEntity {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return CephalariMountEntity.createBaseAttributes().add(net.minecraft.world.entity.ai.attributes.Attributes.MAX_HEALTH, 30.0D);
    }
