...
public class ModItems {
    ...
    public static final RegistryObject<Item> TRADER_BEETLE_SPAWN_EGG =
        ITEMS.register(
            "trader_beetle_spawn_egg",
    ...
    public static final RegistryObject<Item> CEPHALARI_ZOMBIE_SPAWN_EGG =
        ITEMS.register(
            "cephalari_zombie_spawn_egg",
