...
public final class EchowoodMegaSchematicFeature extends Feature<NoneFeatureConfiguration> {
    private final ResourceLocation schematicResource;

    public EchowoodMegaSchematicFeature(Codec<NoneFeatureConfiguration> codec, ResourceLocation schematicResource) {
        super(codec);
            ...
            for (int y = 0; y < height; y++) {
                for (int z = 0; z < length; z++) {
                    for (int x = 0; x < width; x++) {
                        ...
                        BlockState mapped = EchowoodSchematicMapping.mapStateForMega(state, random);
