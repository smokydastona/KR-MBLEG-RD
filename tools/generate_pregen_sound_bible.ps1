...
$docLines.Add('  - `src/main/resources/assets/kruemblegard/lang/en_us.json` (only if subtitle text is provided; then run `./tools/sync_lang_files.ps1` to refresh the locale set)')
