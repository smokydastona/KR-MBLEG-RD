...
$docLines.Add('  - `src/main/resources/assets/kruemblegard/lang/en_us.json` (only if subtitle text is provided; then run `python tools/sync_lang_locales.py` to refresh the mirrored locale set)')
